+function ($) {
	...
	Confirmation.prototype.setContent = function () {
		...
		$btnOk.addClass(this.getBtnOkClass())
			...
			.attr('data-method', this.getDataMethod())
	...
	Confirmation.prototype.getDataMethod = function () {
		var $e = this.$element;
		var o  = this.options;

		return $e.attr('data-method') || (typeof o.dataMethod == 'function' ? o.dataMethod.call($e[0]) : o.dataMethod);
	}
